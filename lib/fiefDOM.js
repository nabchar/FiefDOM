...
window.$f = (arg) => {
  switch (typeof(arg)) {
    ...
    case 'string':
      ...
      return new __WEBPACK_IMPORTED_MODULE_0__dom_node_collection___default.a(nodes);
    default:
      return new __WEBPACK_IMPORTED_MODULE_0__dom_node_collection___default.a([arg]);
  }
};
